...
public class MailConst {
	...
	public static final int TYPE_INVITE_REWARDTASK_MAIL = 8;//工会boss邀请
	public static final int TYPE_HELP_EVENT = 9;//帮助打关卡事件
	public static final int TYPE_INVITE_FIGHTBOSS_MAIL = 10;//世界boss邀请
	public static final int TYPE_INVITE_TEAMRAID_MAIL = 11;//团本邀请
	...
	public static final int[] MAIL_TYPES = {TYPE_SYSTEM_MAIL, TYPE_ADDFRIEND_MAIL, TYPE_APPLY_UNION_MAIL, TYPE_UNION_REFUSED_MAIL, 
		TYPE_HELP_ATTACK_PVP_MAIL, TYPE_CALL_BROTHER_MAILL, TYPE_HELP_EVENT, TYPE_SEND_FRIEND_INFO_MAIL, TYPE_INVITE_REWARDTASK_MAIL, TYPE_INVITE_FIGHTBOSS_MAIL, TYPE_INVITE_TEAMRAID_MAIL};
