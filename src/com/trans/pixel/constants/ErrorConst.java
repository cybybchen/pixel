...
public enum ErrorConst implements ResultConst {
    ...
    NEED_LEADER_OFFLINETIME(2068, "会长离线必须超过7天"), PROP_IS_EXIST_ERROR(2069, "该道具无法重复合成"), REQUEST_WAIT_ERROR(2070, "请求过于频繁，请稍后在试哦"), 
    RECHARGE_TIMEOUT(2071, "购买的计费点不在有效期"), RECHARGE_OVERTIME(2072, "购买计费点次数超出上线"),
