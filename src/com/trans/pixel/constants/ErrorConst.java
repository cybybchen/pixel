...
public enum ErrorConst implements ResultConst {
	...
	UNIONLEADER_QUIT(2013, "会长不能退出自己的工会"),ATTACK_SELF(2014, "不能挑战自己"),MAPINFO_ERROR(2015, "地图信息错误"),
    ...
    EQUIP_FENJIE_ERROR(1025, "装备分解异常"), SIGN_ERROR(1026, "签到异常"), SERVER_ERROR(1100, "服务器异常错误");
