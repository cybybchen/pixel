...
public enum ErrorConst implements ResultConst {
	...
	TIME_RETRY(2038, "时间未到,请稍后在试"),NEED_VIP8(2039, "尚未开启,vip8后开放"),HERO_HAS_FENJIE(2040, "请勿重复分解英雄"),
    ...
    LOOT_PACKAGE_LIMIT_ERROR(1042, "挂机背包数量已达上限"), HEAD_NOT_EXIST(1043, "不存在该头像"),
