...
public enum ErrorConst implements ResultConst {
	SHOP_OVERTIME(2000, "商品已售完"),NOT_ENOUGH(2001, "物品不足"),NOT_ENOUGH_HERO(2002, "英雄不足"),NOT_ENOUGH_PROP(2003, "道具不足"),
	NOT_ENOUGH_CHIP(2004, "材料不足"),NOT_ENOUGH_MAGICCOIN(2005, "魔晶不足"),NOT_ENOUGH_EXPEDITIONCOIN(2006, "斗币不足"),NOT_ENOUGH_LADDERCOIN(2007, "荣誉不足"),NOT_ENOUGH_UNIONCOIN(2008, "公会币不足"),
    ...
    SHARE_SUCCESS(2052, "分享成功"),ROOM_ERROR(2053, "战斗已开始，不能查看队员"), REWARD_ERROR(2054, "奖励领取异常"), HERO_STAR_FIRST(2055, "请先提升英雄星级"), 
    ...
    RECHARGE_TIMEOUT(2071, "购买的计费点不在有效期"), RECHARGE_OVERTIME(2072, "购买计费点次数超出上线"), RAID_LOCKED_ERROR(2073, "您还没有解锁该副本"), RAID_NOTOPEN_ERROR(2074, "您还没开启该副本"),
    RAID_PASS_ERROR(2075, "您已通关该副本"),
    ...
    "准备时间不足"), HERO_NOT_EXIST(1004, "人物不存在"), HERO_LEVEL_MAX(1005, "等级已达上限"), NOT_ENOUGH_EXP(1006, "经验不足"),
    ...
    SKILL_CAN_NOT_LEVELUP(1021, "该技能无法升级"), SP_NOT_ENOUGH(1022, "技能点不足"), HERO_STAR_NOT_LEVELUP(1023, "升星异常"), PROP_USE_ERROR(1024, "道具使用异常"), 
    ...
    FRIEND_NOT_EXIST(1033, "该玩家不存在"), VIP_IS_NOT_ENOUGH(1033, "VIP等级不足"), EQUIP_SALE_ERROR(1034, "装备出售异常"),
    ...
    USER_NAME_IS_EXIST_ERROR(1049, "该用户名已存在"),
    ...
    UNIONBOSS_TIME_OVER_ERROR(3008, "公会BOSS时间异常"), UNIONNAME_IS_EXIST_ERROR(3009, "公会名已被注册"), OPEN_FETTER_ERROR(3010, "羁绊激活异常"),
    HAS_OPEN_FETTER_ERROR(3011, "该羁绊已激活"), NOT_ENOUGH_CLEARPROP_ERROR(3012, "洗练道具不足"), NEED_UNION_ERROR(3013, "请先创建一个公会"),
    
    BATTLETOWER_SUBMIT_ERROR(4001, "战斗塔成绩提交异常"), BATTLETOWER_RESET_ERROR(4002, "战斗塔重置异常"), SUBMIT_BOSS_SCORE_ERROR(4003, "成绩提交异常"),
    NOT_ENOUGH_ZHAOHUANSHI(4004, "召唤石不足"), BOSS_HAS_ZHAOHUAN(4005, "该boss已被召唤"), BOSS_CANNOT_ZHAOHUAN(4006, "今日已无法召唤该boss"),
    TALENTUPGRADE_ERROR(4007, "升级经验不足"), TALENT_NOT_EXIST_ERROR(4008, "该职业尚未解锁"), TALENTCHANGESKILL_ERROR(4009, "天赋切换异常"),
    ...
    BOSS_ROOM_HAS_START(4014, "房间已开始战斗"), BOSS_ROOM_CAN_NOT_QUIT_OTHER(4015, "你不是房主"), BOSS_ROOM_IS_NOT_START_OTHER(4016, "房间还没开始"),
    ...
    FIGHTINFO_IS_NOT_EXIST_ERROR(5034, "该录像不存在"), UNION_ZHANLI_IS_NOT_ENOUGH_ERROR(5035, "公会战力不足15W无法参加"),
