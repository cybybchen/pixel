...
public enum ErrorConst implements ResultConst {
    ...
    CREATE_UNION_ERROR(2048, "公会创建失败"),AREA_OWNER_BUSY(2049, "领主不能退出公会"),EVENT_FIRST(2050, "请先通关所有事件"),
    ...
    BOSS_IS_NOT_EXIST_ERROR(4020, "奖励不存在"), EQUIP_IS_NOT_EXIST_ERROR(4021, "装备不存在"), EQUIP_CHANGE_ERROR(4022, "装备切换异常"),
    ROOM_IS_NOT_EXIST_ERROR(4023, "房间不存在"),
