...
public enum ErrorConst implements ResultConst {
	...
	NOT_ENOUGH_CHIP(2004, "碎片不足"),NOT_ENOUGH_MAGICCOIN(2005, "魔石不足"),NOT_ENOUGH_YUANZHENGCOIN(2006, "远征积分不足"),NOT_ENOUGH_LADDERCOIN(2007, "天梯积分不足"),NOT_ENOUGH_UNIONCOIN(2008, "公会币不足"),
