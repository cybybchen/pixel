...
public enum ErrorConst implements ResultConst {
	...
	NOT_ENOUGH_CHIP(2004, "碎片不足"),NOT_ENOUGH_MAGICCOIN(2005, "魔晶不足"),NOT_ENOUGH_EXPEDITIONCOIN(2006, "战斗币不足"),NOT_ENOUGH_LADDERCOIN(2007, "荣誉不足"),NOT_ENOUGH_UNIONCOIN(2008, "公会币不足"),
    ...
    NOT_ENOUGH_ZHAOHUANSHI(4004, "召唤石不足"),
