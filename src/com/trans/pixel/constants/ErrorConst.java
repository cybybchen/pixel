...
public enum ErrorConst implements ResultConst {
	...
	UNLOCK_ORDER_ERROR(2042, "请按顺序解锁"),NOT_ENOUGH_ZHANLI(2043, "需要更高的战力"),USER_HAS_UNION(2044, "该玩家已加入其他工会"),
    GET_REWARD_AGAIN(2045, "请勿重复领取"), LADDER_RANK_ISCHANGED_ERROR(2046, "天梯排行榜已更新"), BROTHER_VIP_IS_NOT_ENOUGH(2047, "你的大哥VIP等级不足"),
    CREATE_UNION_ERROR(2048, "工会创建失败"),
    ...
    HERO_CLEAR_LEVEL_IS_LIMIT_ERROR(3005, "英雄等级已达上限"), CLEAR_CHOSE_ERROR(3006, "洗练结果异常"),
