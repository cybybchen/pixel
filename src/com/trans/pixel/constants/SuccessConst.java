...
public enum SuccessConst implements ResultConst {
	...
	SHARE_SUCCESS(2010, "分享成功"), SKILL_STONE_SUCCESS(2011, "技能石使用成功"), ATTACK_SUCCESS(2012, "攻击成功"), 
	HANDLER_SUCCESS(2013, "处理成功"), APPLY_SUCCESS(2014, "报名成功"),
    ...
    LEVELUP_SKILL_SUCCESS(1025, "技能升级成功"),REWRITE_SUCCESS(1026, "修改成功"), SAVE_SUCCESS(1027, "收藏成功"), ADD_SUCCESS(1028, "添加成功"),
    ...
    BOSS_ROOM_QUIT_SUCCESS(1121, "房间退出成功"), BOSS_SUBMIT_SUCCESS(1122, "提交成功"), EQUIP_STRENGTHEN_FALIED_SUCCESS(1123, "装备强化失败"),
    EQUIP_STRENGTHEN_SUCCESS(1124, "装备强化成功"), PROP_COMPOSE_SUCCESS(1125, "合成成功"), REWARDTASK_GIVEUP_SUCCESS(1126, "悬赏放弃成功"),
	CHANGE_POSITION_SUCCESS(1127, "互换成功");
