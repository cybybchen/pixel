...
public class DateUtil {
	...
	public static String getCurrentDayDateString() {
		return new SimpleDateFormat(TimeConst.DEFAULT_DATE_FORMAT)
				.format(new Date());
	}
	...
	public static String getCurrentDateString() {
		return new SimpleDateFormat(TimeConst.DEFAULT_DATETIME_FORMAT)
				.format(new Date());
	}
	...
	public static String getCurrentTimeString() {
		return new SimpleDateFormat(TimeConst.DEFAULT_TIME_FORMAT)
				.format(new Date());
	}

	public static int getDateId() {
		return Integer.parseInt(new SimpleDateFormat(TimeConst.DATE_FORMAT_INT)
				.format(new Date()));
	}
	...
	public static int intervalMinutes(long timeMillis1, long timeMillis2) {
		...
		return (int) (intervalMillSecond / TimeConst.MILLIONSECONDS_PER_MINUTE + (intervalMillSecond
				% TimeConst.MILLIONSECONDS_PER_MINUTE > 0 ? 1 : 0));
	}
	...
	public static int intervalSeconds(Date date1, Date date2) {
		...
		return (int) (intervalMillSecond / TimeConst.MILLIONSECONDS_PER_SECOND + (intervalMillSecond
				% TimeConst.MILLIONSECONDS_PER_SECOND > 0 ? 1 : 0));
	}
	...
	public static String timeCheck(Date date) {
		...
		if (check < TimeConst.M) {
			...
			time_desc = new SimpleDateFormat(TimeConst.DEFAULT_DATE_FORMAT)
					.format(date);
		}
	...
	public static Date getCurrentDayDate(String time) {
		SimpleDateFormat df = new SimpleDateFormat(
				TimeConst.DEFAULT_DATETIME_FORMAT);
		String now = df.format(new Date());
	...
	public static boolean isInvalidMail(String time) {
		...
		calendar.set(Calendar.DAY_OF_MONTH, calendar.get(Calendar.DAY_OF_MONTH)
				+ RedisExpiredConst.EXPIRED_USERINFO_DAYS);
	...
	public static boolean timeIsAvailable(String startTimeStr, String endTimeStr) {
		return timeIsAvailable(startTimeStr, endTimeStr,
				TimeConst.DEFAULT_DATETIME_FORMAT);
	}

	public static boolean timeIsAvailable(String startTimeStr,
			String endTimeStr, String simpleDate) {
