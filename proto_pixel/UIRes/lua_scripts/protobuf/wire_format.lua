...
wire_format.WIRETYPE_VARINT = WIRETYPE_VARINT
...
wire_format.MessageByteSize = MessageByteSize
...
wire_format.MessageSetItemByteSize = MessageSetItemByteSize

function TagByteSize(field_number)
    return _VarUInt64ByteSizeNoTag(PackTag(field_number, 0))
end
wire_format.TagByteSize = TagByteSize
